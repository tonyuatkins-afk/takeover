...
static effect_entry_t effect_table[] = {
    ...
    { "screen_flicker",   fx_stub },
    { "static_burst",     fx_stub },
    { "text_corrupt",     fx_stub },
    { "text_redact",      fx_stub },
    { "text_rewrite",     fx_stub },
    { "color_shift",      fx_stub },
    { "blackout",         fx_stub },
    { "red_alert",        fx_stub },
    { "screen_scroll",    fx_stub },
    { "cursor_possessed", fx_stub },
    { "screen_melt",      fx_stub },
    { "falling_chars",    fx_stub },
    { "progress_bar",     fx_stub },
    { "fake_bsod",        fx_stub },
    { NULL, NULL }
};
